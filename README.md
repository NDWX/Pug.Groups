...
Multi-tenant role/group membership framework. 

See [Authorized](https://github.com/NDWX/Authorized) for multi-tenant role-based application object authorization framework.

![develop - build](https://github.com/NDWX/Pug.Groups/workflows/develop%20-%20build/badge.svg?branch=develop) ![main - build and NuGet publish](https://github.com/NDWX/Pug.Groups/workflows/main%20-%20build%20and%20NuGet%20publish/badge.svg?branch=main)

[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=NDWX_Pug.Groups&metric=ncloc)](https://sonarcloud.io/summary/new_code?id=NDWX_Pug.Groups) [![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=NDWX_Pug.Groups&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=NDWX_Pug.Groups) [![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=NDWX_Pug.Groups&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=NDWX_Pug.Groups)
